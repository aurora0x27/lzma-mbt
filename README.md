...
- `Preset.extreme`、容器内 PowerPC/IA64/ARM-Thumb/SPARC/ARM64 等 BCJ 过滤器尚未实现（`UnsupportedFeature`）；`.xz` Block Header 过滤器链支持 LZMA2、`Delta -> LZMA2`、`x86 BCJ -> LZMA2` 与 `ARM BCJ -> LZMA2`
